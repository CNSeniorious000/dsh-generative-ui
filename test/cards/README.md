...
Three real generations, kept as fixed input for `scripts/replay-stream.ts` and
...
All three mount and paint (verified in a browser), and all three replay clean: no visible remount,
no frame that fails to compile.

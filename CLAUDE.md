...
**Not one corpus card in 378 carries three of them. 90 of 125 fresh cards do.** The corpus's mode
...
**Make the count re-derivable.** `fresh-rates.ts` prints the histogram itself, for any directory:
    ...
    90 of 125 carry three or more accessibility signals (0→6 1→6 2→23 3→57 4→33)
